package io.github.nikoir.tracker.telegram.command.handler.inline;

import io.github.nikoir.common.dto.request.SeriesSubscriptionRq;
import io.github.nikoir.common.dto.response.SeriesListViewRs;
import io.github.nikoir.tracker.content.facade.SeriesSubscribeFacade;
import io.github.nikoir.tracker.telegram.command.enums.InlineCommandEnum;
import io.github.nikoir.tracker.telegram.command.handler.base.BaseInlineCommand;
import io.github.nikoir.tracker.telegram.service.SeriesSendService;
import io.github.nikoir.tracker.telegram.service.TelegramService;
import io.github.nikoir.tracker.telegram.service.UserSessionService;
...
import static io.github.nikoir.tracker.telegram.command.enums.InlineCommandEnum.SUBSCRIPTIONS;
